    ...
    <main className="pt-32 pb-24 min-h-screen relative">
      <div className="px-6 mb-6">
        <div className="max-w-4xl mx-auto flex flex-col gap-0">
          <p className="text-lg md:text-xl font-medium text-cyan-400 tracking-wider mb-1">Organization</p>
          <h1 className="text-3xl md:text-4xl font-bold tracking-tight text-white">運営</h1>
        </div>
      </div>
