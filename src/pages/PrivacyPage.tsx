              ...
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    <p>➀お問い合わせへの対応： 本サイトからのお問い合わせ、ご意見、ご要望に対する回答および本人確認のため。</p>
                    <p>②受託業務の遂行および連絡： クライアントから受託したAIツールによるデジタル支援業務の遂行、これに伴う提案、協議、成果物の納品、および必要な連絡のため。</p>
                    <p>③料金の請求および決済処理： 有償サービスやワークショップ等における利用料金の請求、決済の確認、およびこれらに付随する連絡のため。</p>
                    <p>④イベント・ワークショップ等の運営： 対面またはオンラインで開催するワークショップやイベントの参加受付、運営管理、および事後アンケート等のご連絡のため。</p>
                    <p>⑤コミュニティ運営・管理： コミュニティ参画メンバーの登録、プロジェクトへのアサイン管理、メンバー間の円滑な連携・連絡のため。</p>
                    <p>⑥本サービスの改善・案内： 本サイトおよび本サービスの利便性向上、新規プロジェクトやイベント等のご案内のため。</p>
                  </div>
                </div>
              </div>
